...
const uint8_t scancode2ascii[256] = { SCANCODE2ASCII_TABLE };
const uint8_t scancode2ascii_shift[256] = { SCANCODE2ASCII_TABLE_SHIFT };
const uint8_t scancode2ascii_ctrl[256] = { SCANCODE2ASCII_TABLE_CTRL };
