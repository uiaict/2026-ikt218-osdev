...
; C code indexes these tables when installing ISR and IRQ gates into the IDT
...
isr_common_stub:
    ...
    ; The interrupt number was pushed before pusha and the segment registers
    push dword [esp + 48]
    call isr_handler
    add esp, 4
...
irq_common_stub:
    ...
    ; The IRQ vector number is in the same stack slot as the ISR number
    push dword [esp + 48]
    call irq_handler
    add esp, 4
