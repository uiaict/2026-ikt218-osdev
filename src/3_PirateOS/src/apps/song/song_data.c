...
/*
 * This file stores the note data for the songs
 * The song player reads from these arrays when the user starts music
 */
...
// The raycaster uses this as its looping background music
...
// Number of notes in the raycaster background theme
const uint32_t raycaster_bg_theme_length = sizeof(raycaster_bg_theme) / sizeof(Note);

// List of songs available through the music command
...
// Total number of songs in the list above
