...
typedef struct {
    int (*play_song)(Song* song); // Function pointer to a function that plays a song
} SongPlayer;

#define MUSIC_RESULT_COMPLETED   0
#define MUSIC_RESULT_EXIT_MENU  -1
#define MUSIC_RESULT_SWITCH_1    1
#define MUSIC_RESULT_SWITCH_2    2
#define MUSIC_RESULT_SWITCH_3    3
